...
# El usuario insertara la información de la altura desde donde el objeto se deja caer, en metros(m)
# dado que el objeto se deja caer desde el reposo (Velocidad inicial V0= 0 m/s)
# Asumiendo que la aceleracion debido a la gravedad es 9.81 m/s^2 y usando la formula 
# Vf= raiz (Vo ^2 + 2gd) 
